...
const form = document.addEventListener("submit", (e) => {
  ...
  const formInputs = document.querySelectorAll("form .formdiv .form-control input");

  const inputName = document.querySelector("input#FName").value;
//   const inputiName = document.querySelector("input#LName").value;
